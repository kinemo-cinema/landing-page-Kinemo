document.addEventListener("DOMContentLoaded", () => {
    ...
    const i18n = {
        en: {
            ...
            contact_desc: "Fill out your details and a Kinemo technical specialist will reach out within one business day to schedule a personalized demo.",
            steps_header: "WHAT HAPPENS NEXT",
            step1_title: "Discovery Call",
            step1_desc: "30-min intro with a technical specialist",
            step2_title: "Personalized Demo",
            step2_desc: "Tailored to your screen count and hardware setup",
            step3_title: "Proposal in 48h",
            step3_desc: "Clear pricing, activation plan, and support breakdown",
            step4_title: "Go-live in < 72h",
            step4_desc: "Your first room active and operating with Kinemo",
            lbl_fullname: "Full name",
            lbl_company: "Cinema chain / Company name",
            lbl_email: "Work email",
            lbl_phone: "Phone number",
            lbl_screens: "Number of screens",
            form_disclaimer: "By submitting, you accept our",
            privacy_link: "privacy policy",
            affiliate_link: "Are you an affiliate? Log in",
            form_success: "Thank you for your request! A Kinemo specialist will reach out shortly.",
            ft_privacy: "Privacy",
            ft_terms: "Terms",
            ft_contact: "Contact"
        },
        es: {
            ...
            contact_desc: "Rellena tus datos y un especialista de Kinemo se pondrá en contacto contigo en un plazo de un día laborable.",
            steps_header: "LO QUE OCURRE DESPUÉS",
            step1_title: "Llamada de descubrimiento",
            step1_desc: "30 min con un especialista técnico",
            step2_title: "Demo personalizada",
            step2_desc: "Adaptada a tu número de salas y equipos",
            step3_title: "Propuesta en 48h",
            step3_desc: "Precio, plan de activación y soporte",
            step4_title: "Go-live en < 72h",
            step4_desc: "Tu primera sala operativa con Kinemo",
            lbl_fullname: "Nombre completo",
            lbl_company: "Nombre de la cadena de cines",
            lbl_email: "Correo electrónico del trabajo",
            lbl_phone: "Número de teléfono",
            lbl_screens: "Número de pantallas",
            form_disclaimer: "Al enviar, aceptas nuestra",
            privacy_link: "política de privacidad",
            affiliate_link: "¿Eres un afiliado? Inicia sesión",
            form_success: "¡Gracias por tu solicitud! Un especialista de Kinemo te contactará en breve.",
